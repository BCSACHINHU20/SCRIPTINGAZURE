...
blob = BlobClient.from_connection_string(conn_str=connect_str, container_name="bcsachin-container-01", blob_name="sachin1.txt")

with open("./_download.txt", "wb") as my_blob:
