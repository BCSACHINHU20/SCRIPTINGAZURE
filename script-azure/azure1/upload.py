...
blob = BlobClient.from_connection_string(conn_str=connect_str, container_name="bcsachin-container-01", blob_name="a.txt")

with open("./sachin1.txt", "rb") as data:
    blob.upload_blob(data)


blob = BlobClient.from_connection_string(conn_str=connect_str, container_name="bcsachin-container-01", blob_name="b.txt")

with open("./sachin2.txt", "rb") as data:
    blob.upload_blob(data)
